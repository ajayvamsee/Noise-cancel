...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        originalName = findViewById(R.id.original_file);
        cleanName = findViewById(R.id.clean_file);
        modelLabel = findViewById(R.id.model_label);
        playOriginal = findViewById(R.id.play_original);
        stopOriginal = findViewById(R.id.stop_original);
        playClean = findViewById(R.id.play_clean);
        stopClean = findViewById(R.id.stop_clean);
        buttonChangeFile = findViewById(R.id.choose_file);
        buttonNewRecording = findViewById(R.id.new_recording);
        switchModel = findViewById(R.id.switch_model);
        runDenoiser = findViewById(R.id.run);
        cleanSpectrogram = findViewById(R.id.clean_SV);
        originalSpectrogram = findViewById(R.id.original_SV);
